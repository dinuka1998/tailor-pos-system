...
<section>
  ...
  <div class="leftpanel">
    ...
    <div class="leftpanelinner">
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li><a href="MessagesIndexAdmin.php"><i class="fa fa-th-list"></i><span>Customer Messages</span></a></li>
  ...
  <div class="mainpanel">
    ...
    <div class="headerbar">
      ...
      <a class="menutoggle"><i class=""></i></a>
