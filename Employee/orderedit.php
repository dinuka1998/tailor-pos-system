...
?>
                ...
                <div class="form-group">
					...
					<label>Amount</label><br/>
                 	<?php echo("Rs");?> <input type="text" name="amount" style="width:200px; height: 40px;" value="<?php echo($old['amount']) ?>" /><br/><br/>
				</div>
                
                <div class="form-group">
					
					<label>Paid</label><br/>
                 	<?php echo("Rs");?> <input type="text" name="paid" style="width:200px; height: 40px;" value="<?php echo($old['paid']) ?>" /><br/><br/>
				</div>
